...
\date{June 2015}
\blurb{\href{mailto:mathlin@kth.se}{mathlin@kth.se}\break \\ Master's Thesis at KTH Royal Institute of Technology\\Computer Science and Communication (CSC)\break \\ Supervisor: Sten Andersson\\Examiner: Olle Bälter\break \\ June 7, 2015}
...
The large scope of the Agile Development methodologies, the many social parameters, and variety of projects means that the outcome of this report can not come to definite conclusions. It can not for example conclude that a certain methodology is the absolute best choice for small-scale projects. This also explains the vague word \emph{suitable} in the goals section above. This is brought up again in \fullref{sec:discussion}. The report should be seen as an comprehensive, theoretical and experiential based investigation. 
...
This chapter aims to theoretically compare the four agile methodologies to each other with focus on small-scale projects. At the end one methodology is selected to be used for the project, see \fullref{sec:project_description}. For the reader that skipped some parts of the prior chapter, it might be interesting to read \fullref{other_methodologies} that explains how the four methodologies were chosen for this report.
...
It is certainly possible to include all practices for a small-scale project but it would also most certainly lead to lots of overhead work when so few people are involved.
...
\begin{figure}[h]
  \centering
    \includegraphics[width=0.87\textwidth]{img/groupworld.png}
