...
Kanban became the chosen methodology for the project. There are several reasons for the methodology to be favorable for the project. The methodology covers most of the agile principles but is extremely lightweight compared to Scrum and especially \gls{xp}. For a small project this is essential since the smaller the project team the larger the overhead for a methodology. And in this perticular project there will be just one developer and the owner of the project. The fact that Kanban is meant to be expanded on demand and that methodologies like Scrum-ban exists also means that it should be easy to let the methodology grow as the project/company grows.
