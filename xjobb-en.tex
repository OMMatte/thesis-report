...
The information regarding the practices of Scrum is mainly taken from the book \emph{Agile Project Management with Scrum} by Ken Schwaber together with updated information from \url{www.scrumguides.org} \cite{key21} \cite{key15}. Ken Schwaber is one of the authors of The Agile Manifesto.
...
As seen in Figure \ref{fig:scrum} the sprint is very central in Scrum. The sprint is a short period of time, usually a couple of weeks up to a month \cite{key15}. As soon as one sprint ends, another starts. The sprint can be summarized with four main characteristics which can all be seen in Figure \ref{fig:scrum} and are described below.
