...
The report will begin by giving background in \fullref{sec:agile_development}. This background includes interpretations and simplifications by the author in order to assist the inexperienced reader, this is especially true for the figures supplied. Following is \fullref{sec:agile_methodologies} which is a comprehensive background and walkthrough of a few agile methodologies and their practices. Some of these practices will be mentioned throughout the rest of the report. Note that whenever a practice is mentioned it is capitalized as a title. This is to emphasize to the reader that this is a practice and has a section in the agile methodology chapter, without having to fill the report with references. 

The report does not have a strict method and result section. Having them strictly separated is not suitable for this kind of report. The reason for this is that the workflow of finding suitable agile methodologies and strategies goes through sort of iterations and slowly build up piece by piece. This, together with the fact that the report is meant to be used as a guide for inexperienced small project teams, makes it more natural to let the reader follow the same workflow as the project went through.

In \fullref{sec:method_teori} a short theoretical evaluation is conducted with the agile methodology background as the basis. In the end of this chapter one methodology is selected to be used in the project. Afterwards, in \fullref{sec:the_project}, the project is initially described. This chapter goes through how the chosen methodology is used and how it developed over the course of the project. The chapter also brings up the practical results of the actual project together with a short interview showing how the experience was for the projects product owner. The reasoning behind important decisions are incorporated to give the reader some insight. 

The report ends with \fullref{sec:discussion}. Here the developer, who is the report writer, gives his experience of the project. The overall results of the project are discussed and interesting information and critique regarding the report and project are brought forward.

Several figures in the report heavily make use of colors. Therefor it is recommended, for the reader that uses a black and white printout, to have access to a digital colored version. Also, each reference to figures and chapters/sections are colored red. What might be most important to point out is that each glossary entry are colored red to emphasize to the reader that more information is available in the glossary at the end of the report.
...
Regarding agile development, in future research this report can be used as an expert review when investigating agile development methodologies and strategies in small projects. This report not only talks about how agile methodologies can be applicable to small projects but also offers a well documented example of how to practically do it using Kanban. This is something rarely seen in literature and research papers about agile development. Since Kanban is a lightweight methodology ,that have several alternative expanded versions, this report might also offer some assistance in further developing alternative methodologies using Kanban as the base. 
